...
Minim's compiler architecture has minimal allocations and uses Data Oriented Design heavily,  
`mini.nim`, instead, declares its internal data structures relying on Nim's GC.  
_(note: This does not influence the code generated by either compiler._  
_Their codegen is completely independent from their internal architecture and implementation)_  
